...
import com.ruslangrigoriev.topmovie.domain.utils.loadImageLarge
...
//            favorite.visibility =
//                if (checkFavorites(favoriteList, id)) ImageView.VISIBLE else ImageView.GONE
        }
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        //val favoriteList = parent.context.getFavorites()
        return ViewHolder(view, onItemClicked, favoriteList)
    }
}
